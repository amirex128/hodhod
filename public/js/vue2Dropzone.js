!function (e, t) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = e || self).vue2Dropzone = t()
}(this, function () {
    "use strict";
    var e, t = (function (e) {
        var t = function () {
    ...
    return function (e, t, i, n, r, o, s, a, l, u) {
        ...
        mounted() {
            ...
            this.dropzone.on("thumbnail", function (t, i) {
                ...
                e.$emit("vdropzone-file-added", t), e.isS3 && e.wasQueueAutoProcess && e.getSignedAndUploadToS3(t)
        ...
        methods: {
            manuallyAddFile: function (e, t) {
                ...
                let i = !1;
                if ((t.indexOf(".svg") > -1 || t.indexOf(".png") > -1 || t.indexOf(".jpg") > -1 || t.indexOf(".jpeg") > -1) && (i = !0), this.dropzone.options.createImageThumbnails && i && e.size <= 1024 * this.dropzone.options.maxThumbnailFilesize * 1024) {
