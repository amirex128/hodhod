...
@section('content')
    @include('users.partials.header', ['title' => 'ویرایش برند'])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">مدیریت برند ها</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('brand.update',$brand) }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <h6 class="heading-small text-muted mb-4">اطلاعات برند</h6>
                            <div id="brand" class="pl-lg-4">
                                <div class="row rtl">
                                    <div class="col-sm-12">
                                        <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                                            <p class="form-control-label text-right">عنوان برند :</p>
                                            <input type="text" name="title" id="input-name"
                                                   class="form-control form-control-alternative{{ $errors->has('title') ? ' is-invalid' : '' }}"
                                                   placeholder="عنوان برند را وارد نمایید..."
                                                   value="{{ old('title',$brand->title) }}" required autofocus>
                                    ...
                                    <div class="col-sm-12 mb-4 mt-4">
                                        ...
                                        <div class="form-group{{ $errors->has('icon') ? ' has-danger' : '' }}">
                                            <p class="form-control-label text-right">تصویر برند :</p>
                                            <input type="file"
                                                   name="image"
                                                   data-min-width="100"
                                                   data-max-width="700"
                                                   ...
                                                   data-min-height="100"
                                                   data-max-height="600"
                                                   data-default-file="{{request()->root()}}/{{$brand->image}}"
                                                   class="dropify-icon"
                                            >
                                            <input type="hidden" value="{{$brand->image}}" name="image2">
                                            @if ($errors->has('icon'))
                                                <span class="invalid-feedback" role="alert">
                                                     </span>
                                            @endif
