...
@section('content')
    @include('users.partials.header', ['title' => 'ویرایش سایز'])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">ویرایش سایز ها</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('size.update',$size) }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="title" id="input-name"
                                                   ...
                                                   value="{{ old('title',$size->title) }}" required autofocus>
