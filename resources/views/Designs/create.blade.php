...
@section('content')
    @include('users.partials.header', ['title' => 'افزودن طرح'])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">مدیریت طرح ها</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('design.store') }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
