...
@section('content')
    <div id="var0" style="opacity: 0">{{$banner->type[0]}}</div>
    <div id="var1" style="opacity: 0">{{$banner->type[1]}}</div>
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('banner.update2',$banner) }}" autocomplete="off"
                                ...
                                <div class="row rtl">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <label class="custom-toggle">
                                            <input type="checkbox" {{$banner->status==1?"checked":""}} name="status" value="true" checked>
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <div v-if="type==1"
                                            ...
                                            <select name="selected[1]"
                                                ...
                                                @foreach($products as $product)
                                                    ...
                                                    <option
                                                            {{$product->id==$banner->select[0]?"selected":""}}
                                        ...
                                        <div v-if="type==2"
                                            ...
                                            @category(['name'=>'selected[1]','items'=>$banner->select[0]])
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <div v-if="type2==1"
                                            ...
                                            <select name="selected[2]"
                                                ...
                                                @foreach($products as $product)
                                                    ...
                                                    <option
                                                            {{$product->id==$banner->select[1]?"selected":""}}
                                                            value="{{$product->id}}">{{$product->title}} </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div v-if="type2==2"
                                            ...
                                            <p class="form-control-label text-right">انتخاب
                                                دسته بندی بنر چپ :</p>
                                            @category(['name'=>'selected[2]','items'=>$banner->select[1]])
                                    ...
                                    <div class="col-sm-6 ">
                                        <p class="form-control-label text-right">انتخاب
                                            اولویت بنر :</p>
                                        <input value="{{old('priority',$banner->priority)}}" type="number" name="priority"
                                    ...
                                    <div class="col-sm-6 mt-3">
                                        ...
                                        <input type="file"
                                               name="image2"
                                               data-default-file="/{{$banner->image2}}"
                                               data-min-width="100"
                                               data-max-width="700"
...
'imageFormat': 'فرمت تصاویر غیر استاندارد میاشد باید از فرمت های png jpg'
        ...
        new Vue({
            ...
            methods: {},
            created() {
                this.type = document.getElementById('var0').innerText;
                this.type2 = document.getElementById('var1').innerText;
            }
        })
    </script>
@stop
