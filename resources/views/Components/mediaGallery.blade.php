                        ...
                        <div class="row">
                            ...
                            <div class="col-12 row">
                                <div class="col-lg-3 d-flex flex-column justify-content-start align-items-stretch">
                                    <button v-on:click.prevent="addLocalStorage()" class="btn btn-sm btn-block btn-success">درج
                                        تصاویر انتخابی
                                    </button>
                                    <button v-on:click.prevent="forceDelete()" class=" btn btn-sm btn-block btn-danger">حذف
                                        برای همیشه
                                    </button>
                                </div>
                                <div class="col-lg-9">
