...
@section('content')
    @include('users.partials.header', ['title' => 'ویرایش سوالات'])
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('qas.update',$qas) }}" >
                            @csrf
                            @method('put')
                                ...
                                <div class="row rtl">
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <input type="text" name="quest" id="input-name"
                                               ...
                                               value="{{ old('title',$qas->quest) }}" required autofocus>
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <textarea   name="answer"  rows="7"
                                                    class="form-control"
                                                    placeholder="عنوان سوالات را وارد نمایید...">{{$qas->answer?:""}}</textarea>
                                    </div>
                                    <div class="col-sm-12">
