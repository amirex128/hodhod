...
@section('content')
    @include('users.partials.header', ['title' => 'ویرایش اسلایدر'])
    ...
    <div class="container-fluid mt--7">
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        @errors()
                        <div id="slider">
                            <form method="post" action="{{ route('slider.update',$slider) }}" autocomplete="off"
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div v-if="type==1">
                                                ...
                                                @foreach($products as $product)
                                                    ...
                                                    <option
                                                            @if($slider->type==1)
                                                                @if(is_array($slider->selected))
                                                                    @if(in_array($product->id,$slider->selected))
                                                                    selected
                                                                    @endif
                                                                @elseif($product->id==$slider->selected)
                                                                selected
                                                                @endif
                                                            @endif
         ...
         @category(['name'=>'selected','title'=>'انتخاب دسته بندی','items'=>$slider->selected])
...
@javascript('my_type',$slider->type)
