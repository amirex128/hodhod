...
@section('content')
    @include('users.partials.header', ['title' => 'افزودن رنگ'])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">مدیریت رنگ ها</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('color.store') }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="row rtl">
                                    ...
                                    <div class="col-sm-12">
                                        <p class="form-control-label text-right">کد رنگ :</p>
                                            <div id="example" class="btn btn-block mb-3 btn-success ">انتخاب رنگ</div>
