...
@section('content')
    @include('users.partials.header', ['title' => 'ویرایش محصول '])
                                                    ...
                                                    <div class="form-group{{ $errors->has('body') ? ' has-danger' : '' }}">
                                                        ...
                                                        <div class="col-sm-12 text-right">
															<textarea id="summernote"
                                                                      name="editordata">{{$product->body}}</textarea>
                                                ...
                                                <div class="col-sm-6">
                                                    <div
                                                        ...
                                                        <select name="situation"
                                                            ...
                                                            <option {{$product->situation==0?"selected":""}} value="0">
                                                                موجود
                                                            </option>
                                                            <option {{$product->situation==1?"selected":""}} value="1">
                                                                توقف تولید
                                                            </option>
                                                            <option {{$product->situation==2?"selected":""}} value="2">
                                                                بزودی
                                                            </option>
                                                            <option {{$product->situation==3?"selected":""}} value="3">
                                                                ناموجود
                                                            </option>
                                                        </select>
                                                        ...
                                                        <select multiple class="demo form-control" name="categories[]" id="">
                                                            @foreach($categories as $category)
                                                                <option
                                                                        ...
                                                                        {{in_array($category->id,(array) $product->categories->pluck("id")->toArray())?'selected':""}}
                                                                        @endif


                                                                        value="{{$category->id}}">{{$category->name}}</option>
                                                                @if(count($category->childrenRecursiveProduct)>0)
                                                                    @include("Products.partials.row",["categories"=>$category->childrenRecursiveProduct,"old"=>old("categories"),"product"=>$product,"level"=>1])
                                                                @endif
                                                            @endforeach
                                                    ...
                                                    <div class="form-group">
                                                        <select name="designs[]" class="demo w-100 "
                                                            ...
                                                            @foreach($designs as $design)
                                                                <option
                                                                        {{in_array($design->id,$product->designs->pluck('id')->toArray())?"selected":""}}
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <select name="related[]" class="my-select" multiple="multiple">
                                                        @foreach ($productss as $item)
                                                            <option data-img-src="/{{$item->image}}"
                                                                    {{in_array($item->id,$related)?"selected":""}}
